...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.60\textwidth}\centering
    \begin{tikzpicture}[scale=1.0, level distance=13mm,
      ...
      \node[tree node] {A: $t{=}0,\,j{=}1,\,i{=}1$}
        child {node[tree node] {B: $t{=}1,\,j{=}1,\,i{=}0$}
          child {node[tree leaf] {$\region{0,0}{1,1}$}}
          child {node[tree leaf] {$\region{0,2}{1,3}$}}
        }
        child {node[tree node] {C: $t{=}1,\,j{=}2,\,i{=}3$}
    ...
    are regions still to be divided, not corridors.}
  ...
  Proposition~\ref{prop:tree}, $L-1$ are division doors and the rest
