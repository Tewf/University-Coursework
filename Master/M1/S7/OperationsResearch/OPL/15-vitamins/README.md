# Diet problem, vitamin requirements

Model, as a linear program, how much of six foods a family should buy to meet its vitamin A and C requirements at minimum cost.
...
- `handout/15-vitamins.md` — the original Caseine statement, wording untouched
- `vitamins.mod` — blank OPL template: objective and constraints empty
- `configExe` — the Caseine grader config, names `vitamins.mod`
