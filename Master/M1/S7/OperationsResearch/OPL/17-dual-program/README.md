# Write the dual of a program

Write, by hand, the dual of the given three-variable minimisation linear program.
...
- `handout/17-dual-program.md` — the original Caseine statement, wording untouched
- `dual.mod` — blank OPL template, the primal's cost array given; objective and constraints empty
- `configExe` — the Caseine grader config, names `dual.mod`
