# Jam production planning

Model, as a linear program, how many pots of rhubarb and strawberry jam to make from fixed stocks of rhubarb, strawberries and sugar, to maximise profit.
...
- `handout/07-jam.md` — the original Caseine statement, wording untouched
- `confiture.mod` — blank OPL template: objective and constraints empty
- `configExe` — the Caseine grader config, names `confiture.mod`
