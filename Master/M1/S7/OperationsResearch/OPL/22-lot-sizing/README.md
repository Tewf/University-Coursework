# Lot sizing with .dat files

Confirm the lot-sizing example model runs and evaluates as given, with its data loaded from `data1.dat`.
...
- `handout/22-lot-sizing.md` — the original Caseine statement, wording untouched
- `lotsizing.mod` — the tutorial's own worked lot-sizing example, data-driven, ready to run
- `data1.dat` — the periods, demands and cost data for the example instance
- `configExe` — the Caseine grader config, names `lotsizing.mod` and `data1.dat`
