...
def query_open_meteo(latitude : float, longitude : float, start_date : str, end_date : str) -> json:
...
if __name__ == "__main__":
    ...
    grenoble_data = query_open_meteo(COORDINATES["Grenoble"][0], COORDINATES["Grenoble"][1], 
