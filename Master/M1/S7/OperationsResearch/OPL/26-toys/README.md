...
The statement is a Caseine VPL exercise (Hadrien Cambazard, Olivier Briant) and is not redistributed here: see [NOTICE](../../../../../../NOTICE). It stays with the work on the private side, in `handout/`, and `.publishignore` keeps it out of this copy.
