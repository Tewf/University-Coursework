...
% they were never there to remove.
\begin{figure}[htbp]
  \centering
  ...
  \end{subfigure}
  \caption{One division, with $t=1$. The call draws the wall position $j$ and
  the door position $i$, links $(j,i)$ to $(j{+}1,i)$, and recurses on the two
  halves. Counting edges: $11$ on the left, $7$ on the right, one door, total
  $19=20-1$ on $20$ cells --- the tally of
  Proposition~\ref{prop:generation-is-a-tree}, assembled one edge per call.}
