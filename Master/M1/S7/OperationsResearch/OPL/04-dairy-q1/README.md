# Dairy product mix, question 1

Model, as a linear program, how much of three cheeses a dairy co-operative should make from its weekly milk supply and labour hours to maximise revenue, selling off whatever milk goes unused.
...
- `handout/04-dairy-q1.md` — the original Caseine statement, wording untouched
- `laiterieQ1.mod` — blank OPL template: the cost array is given, the objective and constraints are empty
- `configExe` — the Caseine grader config, names `laiterieQ1.mod`
