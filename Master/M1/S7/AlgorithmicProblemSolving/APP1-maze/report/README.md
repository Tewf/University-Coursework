...
The report for *Be Amazed*: the maze stated as a graph problem, generated by
recursive division, then walked back to its exit.
...
handout's requirements against them.
